...
function Nn(s) {
  ...
  let r =
    i.xmin !== t.min || i.xmax !== t.max || i.ymin !== e.min || i.ymax !== e.max
...
function dh(s, t, e, i) {
  let n
  for (let r of t)
    if (((n = qo(rh(r, s), e)), ft(n))) return Un(s, n) ? Yn(e, i, s, n) : n
}
function qo(s, t) {
  for (let e of t) {
    if (!e) continue
    ...
    (b = t[O % o]),
      !b.skip &&
        ...
        y !== _ &&
          ...
          p !== null &&
            k() &&
            (m.push(wo({ start: p, end: O, loop: d, count: o, style: f })),
            (p = null)),
          (T = O),
          (_ = y)))
  return (
    p !== null && m.push(wo({ start: p, end: u, loop: d, count: o, style: f })),
    m
  )
}
function tr(s, t) {
  ...
  pt = class {
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = Vh(
          I(this.options.clip, zh(e.xScale, e.yScale, this.getMaxOverflow()))
        ))
    }
    update(t) {}
    draw() {
...
var je = class extends pt {
  ...
  resolveDataElementOptions(t, e) {
    ...
    let r = n.radius
    return (
      e !== "active" && (n.radius = 0), (n.radius += I(i && i._custom, r)), n
    )
  }
}
je.id = "bubble"
...
function bu(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    if (((f = ot(i, r, a)), A(e))) {
      ...
      e === "center" ? (m = (c.bottom + c.top) / 2 + g - t) : (m = fa(s, e, t))
    d = a - r
  } else {
    if (A(e)) {
      let y = Object.keys(e)[0],
      ...
      e === "center" ? (f = (c.left + c.right) / 2 - p + t) : (f = fa(s, e, t))
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          for (h = 0, u = d.length; h < u; ++h)
            (_ = d[h]),
              !R(_) && !$(_) && ((y = bs(i, g.data, g.gc, y, _)), (b += p))
...
function Vu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver((r) => {
      let o = !1
      for (let a of r)
        (o = o || $i(a.addedNodes, i)), (o = o && !$i(a.removedNodes, i))
      o && e()
    })
...
function Hu(s, t, e) {
  let i = s.canvas,
    n = new MutationObserver((r) => {
      let o = !1
      for (let a of r)
        (o = o || $i(a.removedNodes, i)), (o = o && !$i(a.addedNodes, i))
      o && e()
    })
  return n.observe(document, { childList: !0, subtree: !0 }), n
}
...
function Yu(s) {
  return !qn() || (typeof OffscreenCanvas < "u" && s instanceof OffscreenCanvas)
    ? fr
    : mr
}
var gr = class {
...
function dd(s, t, e) {
  let { x: i, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
    ...
    h
  for (
    e && ol(s, t, r + B), s.beginPath(), s.arc(i, n, c, r + B, r, !0), h = 0;
    h < a;
    ++h
  )
    s.stroke()
...
function pd(s, t, e, i) {
  ...
  for (f = 0; f <= c; ++f)
    (m = n[(a + (d ? c - f : f)) % o]),
      !m.skip &&
        (u ? (s.moveTo(m.x, m.y), (u = !1)) : h(s, g, m, d, r.stepped), (g = m))
...
var Ls = class extends yt {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = df(this.chart.getContext(), this, this._tooltipItems))
    )
  }
  getTitle(t, e) {
    let { callbacks: i } = e,
...
var yf = (s, t) => (s === null ? null : it(Math.round(s), 0, t)),
  Je = class extends Yt {
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && i[e] === t ? e : pf(i, t, I(e, t), this._addedLabels)),
        yf(e, i.length - 1)
      )
    }
    determineDataLimits() {
...
function _f(s, t, e) {
  return (
    (e = $(e) ? e : [e]), { w: Bo(s, t.string, e), h: e.length * t.lineHeight }
  )
}
...
var we = class extends Yt {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit =
        !i.major.enabled || this._unit === "year" ? void 0 : Ff(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
        ...
        o = (f) =>
          t.isOffsetFixed && t.offset === 0 && f.allowZ
            ...
            : t.isValid
              ...
              : "",
        a = () =>
          i ? Nl(t) : r({ hour: "numeric", hourCycle: "h12" }, "dayperiod"),
        l = (f, m) =>
          i
            ? Wl(t, f)
