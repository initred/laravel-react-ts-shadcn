...
function Jr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1
      for (let r of o)
        (a = a || fi(r.addedNodes, s)), (a = a && !fi(r.removedNodes, s))
      a && e()
    })
...
function Qr(i, t, e) {
  let s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1
      for (let r of o)
        (a = a || fi(r.removedNodes, s)), (a = a && !fi(r.addedNodes, s))
      a && e()
    })
  return n.observe(document, { childList: !0, subtree: !0 }), n
}
...
function nl(i) {
  return !Ji() || (typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas)
    ? bs
    : _s
}
var xs = class {
      ...
      return (
        ...
        new ze(this.$refs.canvas, {
          ...
          data: {
            labels: t,
            datasets: [
              { data: e, borderWidth: 2, fill: "start", tension: 0.5 },
            ],
          },
          options: {
