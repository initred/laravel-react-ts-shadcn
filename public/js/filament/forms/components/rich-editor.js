  ...
  $e = function (n) {
    ...
    return t
      ...
      : ot(n) ||
          (!ot(n.firstChild) &&
            (function (e) {
              return vt().includes(x(e)) && !vt().includes(x(e.firstChild))
            })(n))
  },
      ...
      this.prototype[e] = function () {
        ...
        return (
          i
            ...
            : r && (a = this[r]),
          o
            ? ((s = (l = a) === null || l === void 0 ? void 0 : l[e]),
        ...
        return (() => {
          ...
          return (
            Array.from(n).forEach((e) => {
              ...
              e > 65535 &&
                ((e -= 65536),
                (i += String.fromCharCode(((e >>> 10) & 1023) | 55296)),
                (e = 56320 | (1023 & e))),
...
var _i = 0,
  ...
  Ei = /Mac|^iP/.test(navigator.platform) ? (n) => n.metaKey : (n) => n.ctrlKey,
  He = (n) => setTimeout(n, 1),
  Si = function () {
    let n = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      t = {}
        ...
        Array.from(e).forEach((s) => {
          ...
          if (t) {
            ...
            if (
              ...
              c !== void 0 &&
              c.call(s, i) &&
              (l = (u = t[t.length - 1]).canBeGroupedWith) !== null &&
              l !== void 0 &&
              l.call(u, s, i)
            )
...
var M = class extends b {
  ...
  Ct = class extends M {
    ...
    createCaptionElement() {
      let t = d({ tagName: "figcaption", className: W.attachmentCaption }),
    ...
    getClassName() {
      ...
      return e && t.push("".concat(W.attachment, "--").concat(e)), t.join(" ")
    }
    getData() {
      let t = {
    ...
    getCaptionConfig() {
      ...
      let e = this.attachment.getType(),
        i = Si((t = je[e]) === null || t === void 0 ? void 0 : t.caption)
...
`)
    ...
    createElement() {
      ...
      if (Object.keys(r).length)
        for (e in (t || (t = d("span")), r)) (i = r[e]), (t.style[e] = i)
      return t
    }
    createContainerElement() {
  ...
  lt = class extends M {
    ...
    render() {
      if (
        ...
        let t = yt.groupObjects(this.document.getBlocks(), { asTree: !0 })
        Array.from(t).forEach((e) => {
...
var Wt = class extends at {
  ...
  H = class extends O {
    ...
    static attributesForFile(t) {
      return new C({ filename: t.name, filesize: t.size, contentType: t.type })
    }
    static fromJSON(t) {
      return new this(t)
    }
...
var ct = class extends O {
    ...
    splitObjectsAtRange(t) {
      ...
      return (
        ([i, e] = new this.constructor(i).splitObjectAtPosition(un(t) + o)),
        [i, r, e - 1]
      )
    }
    ...
    isEqualTo(t) {
      return super.isEqualTo(...arguments) || ln(this.objects, t?.objects)
    }
    contentsForInspection() {
      return {
        objects: "[".concat(
  ...
  R = class extends O {
    ...
    getExpandedRangeForAttributeAtOffset(t, e) {
      ...
      for (; i < o && this.getCommonAttributesAtRange([e, i + 1])[t]; ) i++
      return [r, i]
    }
    getTextAtRange(t) {
    ...
    getAttachmentAndPositionById(t) {
      ...
      for (let r of this.pieceList.toArray()) {
        var i
        if (((i = r.attachment) === null || i === void 0 ? void 0 : i.id) === t)
...
`,
  ...
  k = class extends O {
    ...
    copyUsingObjectMap(t) {
      let e = this.getBlocks().map((i) => t.find(i) || i.copyUsingObjectMap(t))
      return new this.constructor(e)
    }
    ...
    insertDocumentAtRange(t, e) {
      ...
      return (
        ...
        new this.constructor(a.blockList.insertSplittableListAtPosition(i, r))
      )
    }
    mergeDocumentAtRange(t, e) {
      ...
      if (Q(c, l)) {
        ...
        i = t.copy({ consolidateBlocks: !0 }).copyWithBaseBlockAttributes(a)
...
`
        ...
        let L,
          ...
          it = dt.appendText(P)
        L =
          a !== u && c === 0 && l.getAttributeLevel() >= A.getAttributeLevel()
            ? A.copyWithText(it)
            : l.copyWithText(it)
        let gt = u + 1 - a
    ...
    addAttribute(t, e) {
      ...
      return (
        this.eachBlock(
          (r, o) => (i = i.editObjectAtIndex(o, () => r.addAttribute(t, e)))
        ),
    ...
    applyBlockAttributeAtRange(t, e, i) {
      ...
      let s = v(t)
      if (s.listAttribute) {
        o = o.removeLastListAttributeAtRange(i, { exceptAttributeName: t })
    ...
    removeBlockAttributesAtRange(t) {
      ...
      return (
        this.eachBlockAtRange(t, function (i, r, o) {
          i.hasAttributes() &&
            (e = e.editObjectAtIndex(o, () => i.copyWithoutAttributes()))
        }),
        new this.constructor(e)
      )
    }
      ...
      if (N(t)) return this.getCommonAttributesAtPosition(e)
      {
        ...
        return (
          this.eachBlockAtRange(t, function (o, s) {
            if (s[0] !== s[1])
              return i.push(o.text.getCommonAttributesAtRange(s)), r.push(ci(o))
          }),
    ...
    findRangesForTextAttribute(t) {
      ...
      return (
        this.getPieces().forEach((s) => {
          ...
          })(s) && (r[1] === i ? (r[1] = i + a) : o.push((r = [i, i + a]))),
            (i += a)
        }),
        o
      )
...
`,
        ...
        case "tr":
          if (this.needsTableSeparator(t))
            return this.appendStringWithAttributes(Tt.tableRowSeparator)
          break
        case "td":
          if (this.needsTableSeparator(t))
            return this.appendStringWithAttributes(Tt.tableCellSeparator)
      }
    }
    ...
    getTextAttributes(t) {
      ...
      for (let r in Y) {
        ...
        if (
          ...
          o.styleProperty && ((e = t.style[o.styleProperty]), e && (i[r] = e))
      }
      if ($(t)) {
    ...
    isBlockElement(t) {
      if (
        ...
        !$(t) &&
        !V(t, { matchingSelector: "td", untilNode: this.containerElement })
      )
        return (
          vt().includes(x(t)) || window.getComputedStyle(t).display === "block"
        )
    }
    ...
    requestRemovalOfAttachment(t) {
      ...
      if (this.attachmentIsManaged(t))
        return (e = this.delegate) === null ||
          e === void 0 ||
          (i = e.attachmentManagerDidRequestRemovalOfAttachment) === null ||
          i === void 0
          ? void 0
          : i.call(e, t)
    }
    ...
    insertAttachments(t) {
      ...
      return (
        Array.from(t).forEach((i) => {
          var r
          let o = i.getType(),
            s = (r = je[o]) === null || r === void 0 ? void 0 : r.presentation,
              ...
              ;(o.delegate = this),
                r.push(
                  (s = this.delegate) === null ||
                    s === void 0 ||
                    (a = s.compositionDidAddAttachment) === null ||
                    a === void 0
                    ? void 0
                    : a.call(s, o)
                )
  ...
  qt = class {
    ...
    removeBlockAttribute() {
      return this.findRangesOfBlocks().map(
        (t) => (this.document = this.document.removeAttributeAtRange(be, t))
      )
    }
    applyBlockAttribute() {
      let t = 0
...
` &&
            ...
            e[0]++,
            t++),
          (this.document = this.document.applyBlockAttributeAtRange(be, !0, e)))
      })
    }
    findRangesOfBlocks() {
  ...
  Ht = class {
    ...
    loadHTML() {
      let t =
          arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "",
        e = et.parse(t, { referenceElement: this.element }).getDocument()
      ...
      if (r) {
        if (At(r))
          ...
          if (((e = r.parentNode), !$e(r.previousSibling) && !le(e)))
            for (
              ;
              r === e.lastChild && ((r = e), (e = e.parentNode), !le(e));
  ...
  Bn = function (n) {
    return Fn(n) === NodeFilter.FILTER_ACCEPT ? Fi(n) : NodeFilter.FILTER_REJECT
  },
  Fn = function (n) {
    return yi(n) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT
  },
  Fi = function (n) {
    return $(n.parentNode) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT
  },
  _t = class {
    createDOMRangeFromPoint(t) {
      ...
      if (document.caretPositionFromPoint) {
        let { offsetNode: o, offset: s } = document.caretPositionFromPoint(i, r)
  ...
  I = class extends b {
    ...
    clearSelection() {
      var t
      return (t = Li()) === null || t === void 0 ? void 0 : t.removeAllRanges()
    }
    selectionIsCollapsed() {
      var t
      return ((t = xt()) === null || t === void 0 ? void 0 : t.collapsed) === !0
    }
    selectionIsExpanded() {
    ...
    createDOMRangeFromLocationRange(t) {
      let e = this.findContainerAndOffsetFromLocation(t[0]),
        i = N(t) ? e : this.findContainerAndOffsetFromLocation(t[1]) || e
      if (e != null && i != null) {
    ...
    domRangeWithinElement(t) {
      return t.collapsed
        ...
        : J(this.element, t.startContainer) && J(this.element, t.endContainer)
    }
  }
...
var Pi = Object.freeze({
        ...
        E(
          ...
          xe(() => {
            ...
            return (
              ...
              f("click", { onElement: o, withCallback: this.didClickToolbar }),
              f("click", {
                onElement: o,
              ...
              { do: () => this.element.appendChild(o), undo: () => q(o) }
            )
          })
        ),
        E(
          ...
          xe(() => {
            ...
            f("input", { onElement: o, withCallback: a }),
              f("input", { onElement: o, withCallback: this.didInputCaption }),
              f("keydown", {
                onElement: o,
              ...
              f("blur", { onElement: o, withCallback: this.didBlurCaption })
            ...
            return {
              do: () => {
                if (
                  ...
                  l.appendChild(o),
                  l.appendChild(s),
                  l.classList.add("".concat(_.attachmentCaption, "--editing")),
    ...
    didKeyDownCaption(t) {
      ...
      if (In[t.keyCode] === "return")
        return (
          ...
          (e = this.delegate) === null ||
          e === void 0 ||
          (i = e.attachmentEditorDidRequestDeselectingAttachment) === null ||
          i === void 0
            ? void 0
  ...
  Kt = class extends b {
    ...
    render() {
      ...
      return (
        ...
        this.canSyncDocumentView() &&
          ...
          ((i = this.delegate) === null ||
            i === void 0 ||
            (r = i.compositionControllerWillSyncDocumentView) === null ||
            r === void 0 ||
            r.call(i),
    ...
    attachmentEditorDidRequestRemovalOfAttachment(t) {
      ...
      return (e = this.delegate) === null ||
        e === void 0 ||
        (i = e.compositionControllerDidRequestRemovalOfAttachment) === null ||
        i === void 0
        ? void 0
        : i.call(e, t)
    }
    attachmentEditorDidRequestDeselectingAttachment(t) {
      ...
      return (e = this.delegate) === null ||
        e === void 0 ||
        (i = e.compositionControllerDidRequestDeselectingAttachment) === null ||
        i === void 0
        ? void 0
        : i.call(e, t)
    }
  ...
  ut = class extends b {
    constructor(t) {
      ...
      for (let e in this.constructor.events)
        f(e, { onElement: this.element, withCallback: this.handlerFor(e) })
    }
    elementDidMutate(t) {}
      ...
      return Promise.all(e).then((i) => {
        this.handleInput(function () {
          ...
          return (
            ...
            (o = this.responder) === null || o === void 0 || o.insertFiles(i),
            this.requestRender()
          )
        })
      })
...
E(w, "events", {
    ...
    if (t) {
      ...
      ;["ctrl", "alt", "shift", "meta"].forEach((o) => {
        ...
        ((e = r) === null || e === void 0 ? void 0 : e[t]) != null &&
          (this.setInputSummary({ keyName: t }), tt.reset(), r[t].call(this, n))
    }
    if (Ei(n)) {
  ...
  keypress(n) {
    ...
    return t
      ? ((e = this.delegate) === null ||
        ...
        (i = this.responder) === null || i === void 0 || i.insertString(t),
  ...
  drop(n) {
    var t, e
    n.preventDefault()
    let i = (t = n.dataTransfer) === null || t === void 0 ? void 0 : t.files,
    ...
    if (
      ...
      ;(c = this.responder) === null || c === void 0 || c.insertDocument(l),
        this.requestRender()
    }
  ...
  paste(n) {
    ...
    if (i) {
      ...
      ;(e.type = "text/html"),
        ...
        (a = this.responder) === null || a === void 0 || a.insertHTML(e.html),
        this.requestRender(),
      ...
      if (D) {
        var gt, ie, ne
        let nt = Vn(D)
        !D.name && nt && (D.name = "pasted-file-".concat(++Un, ".").concat(nt)),
          (e.type = "File"),
          (e.file = D),
...
`),
      ...
      left(n) {
        if (this.selectionIsInCursorTarget())
          return n.preventDefault(), this.expandSelectionInDirection("backward")
      },
      right(n) {
        if (this.selectionIsInCursorTarget())
          return n.preventDefault(), this.expandSelectionInDirection("forward")
      },
    },
    alt: {
      backspace(n) {
...
var Vn = (n) => {
  ...
  qn = !((ye = " ".codePointAt) === null || ye === void 0 || !ye.call(" ", 0)),
  Hn = function (n) {
...
var _n = function (n) {
  ...
  Jn = function (n) {
    ...
    if (t)
      return (
        t.types.includes("Files") && t.types.length === 1 && t.files.length >= 1
      )
  },
  Kn = function (n) {
    let t = n.clipboardData
  ...
  $n = function (n) {
    let t = []
    return (
      n.altKey && t.push("alt"), n.shiftKey && t.push("shift"), t.push(n.key), t
    )
  },
  ...
  X = class extends $t {
    constructor(t) {
      ...
      super(...arguments),
        ...
        (this.attachmentManager = new Ut(this.composition.getAttachments())),
        ...
        (this.toolbarController = new Yt(this.editorElement.toolbarElement)),
...
var Qt = class extends HTMLElement {
    ...
    notify(t, e) {
      if (this.editorController)
        return bt("trix-".concat(t), { onElement: this, attributes: e })
    }
